	...
	void Start () {
		for (var i = 0; i < 10; i++)
		{
			if(PlayerPrefs.GetString ("Name" + i) == ""){
				...
				PlayerPrefs.SetString("Name"+0, "Dios");
				PlayerPrefs.SetFloat("Score"+1, 666);
				PlayerPrefs.SetString("Name"+1, "Lucifer");
				PlayerPrefs.SetFloat("Score"+2, 500);
				PlayerPrefs.SetString("Name"+2, "Palpatine");
				PlayerPrefs.SetFloat("Score"+3, 250);
				PlayerPrefs.SetString("Name"+3, "Vader");
				PlayerPrefs.SetFloat("Score"+4, 100);
				PlayerPrefs.SetString("Name"+4, "Gandalf");
				PlayerPrefs.SetFloat("Score"+5, 75);
				PlayerPrefs.SetString("Name"+5, "Saruman");
